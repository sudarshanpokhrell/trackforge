...
const docTemplate = `{
        ...
        "/events": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Per-tab UUID. Events caused by requests that sent the same X-Client-ID header carry it, so that tab can skip them.",
                        "name": "client_id",
                        "in": "query"
                    }
                ],
        ...
        "/projects/{id}/cycles": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "upcoming, active, overdue or completed",
                        "name": "status",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Cycle to create",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.CreateCyclePayload"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.SetCyclesEnabledPayload"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.UpdateCyclePayload"
                        }
                    }
                ],
                "responses": {
        ...
        "/projects/{id}/cycles/{cycleID}/complete": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Where open issues go",
                        "name": "payload",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/main.CompleteCyclePayload"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "main.CompleteCyclePayload": {
            "type": "object",
            "properties": {
                "move_open_issues_to": {
                    "description": "MoveOpenIssuesTo is another uncompleted cycle in the project, or null (or\nleft out) to leave open issues with no cycle.",
                    "type": "integer"
                }
            }
        },
        "main.CreateCyclePayload": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "main.UpdateIssuePayload": {
            ...
            "properties": {
                "cycle_id": {
                    "description": "CycleID moves the issue into a cycle, or out of one with null.",
                    "type": "integer"
                },
                "description": {
                    "type": "string"
        ...
        "store.Cycle": {
            ...
            "properties": {
                ...
                "issue_counts": {
                    "description": "IssueCounts maps each issue status to how many of the cycle's issues have\nit, for progress. Statuses with no issues are absent.",
                    "type": "object",
                ...
                "status": {
                    "description": "Status depends on today's date, so it's worked out per request (see\nSetStatus) rather than stored.",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
        ...
        "store.Project": {
            ...
            "properties": {
                ...
                "cycles_enabled": {
                    "description": "CyclesEnabled is changed only through SetCyclesEnabled, never Update.",
                    "type": "boolean"
                },
                "description": {
                    "type": "string"
